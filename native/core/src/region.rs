...
impl RegionSectionIndex {
    ...
    pub fn from_local_section(local_section_coord: u8x3) -> Self {
        // TODO: morton encode, or don't do morton encoding on the java side
        Self(
            (local_section_coord
                & u8x3::from_array([
                    Self::X_MASK_SINGLE,
